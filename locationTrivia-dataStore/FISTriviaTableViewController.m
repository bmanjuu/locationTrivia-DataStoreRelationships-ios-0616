...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"triviaRightDetailCell" forIndexPath:indexPath];
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    ...
    addTriviaVC.addNewTriviumLocation = self.location;
    
//    FISLocation *selectedLocationTrivia = self.tableView[selectedRow.row];
//    
